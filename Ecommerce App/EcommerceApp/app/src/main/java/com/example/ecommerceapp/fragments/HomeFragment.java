...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        slideModels.add(new SlideModel(R.drawable.banner1,"Discount On Items", ScaleTypes.CENTER_CROP));
        slideModels.add(new SlideModel(R.drawable.banner2,"Discount On Perfums", ScaleTypes.CENTER_CROP));
